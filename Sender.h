...
class Sender : public WdtBase {
 ...
 private:
  ...
  /// Returns the protocol version sender is oeprating with
  ...
  /// General utility used by sender thrreads to connect to receiver
  ...
  std::vector<std::unique_ptr<SenderThread>> senderThreads_;
  ...
  /// Controller for the sender threads, shared between parent sender and
  /// the threads
